...
| **Reliability tier** | The rank a source sits in — AUTHORITATIVE-STRUCTURED (MusicBrainz, Wikidata, LoC/IA public-domain) > REPUTABLE-PRESS (The Guardian, BBC, Pitchfork, The Quietus, Paste…) > EDITORIAL-BLOG (Stereogum, Aquarium Drunkard, Bandcamp Daily…) > CROWD (Discogs notes, Last.fm, Genius community) — which drives the consensus WEIGHT in REQ-KS-006 (REQ-KS-009). Ranked by reliability, NOT license. |
